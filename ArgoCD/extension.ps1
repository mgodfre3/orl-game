...
$RESOURCE_GROUP="ACX-MobileAzl"
$custom_location="Mobile"
$CLUSTER_NAME="mobile-mario"
$Cluster_ResourceGroup="ACX-MobileAZL"
$connectedClusterRg="ACX-MobileAzl"
$ssh_key="mobile-mario-ssh-key"
$nodepoolvm_size="Standard_A4_v2"
$nodecount="1"
